...
export class MountebankService implements OnModuleInit, OnModuleDestroy {
  ...
  private async setupDifeImposter(): Promise<void> {
    ...
    difeStubs.push(
      this.createDifeSuccessStub('3001234567', 'dife-execution-id-mobile', 'dife-trace-id-mobile', {
        type: 'M',
        participant: { nit: '12345678', spbvi: 'CRB' },
    ...
    difeStubs.push(
      this.createDifeSuccessStub('TEST@EXAMPLE.COM', 'dife-execution-id-email', 'dife-trace-id-email', {
        type: 'E',
        participant: { nit: '12345678', spbvi: 'CRB' },
    ...
    difeStubs.push(
      this.createDifeSuccessStub('0012345678', 'dife-execution-id-business', 'dife-trace-id-business', {
        type: 'B',
    ...
    difeStubs.push(
      this.createDifeSuccessStub('1234567890', 'dife-execution-id-nric', 'dife-trace-id-nric', {
        type: 'NRIC',
        participant: { nit: '12345678', spbvi: 'CRB' },
    ...
    difeStubs.push(
      this.createDifeSuccessStub('@CORRIENTE', 'dife-execution-id-ccte', 'dife-trace-id-ccte', {
        type: 'O',
        participant: { nit: '12345678', spbvi: 'CRB' },
    ...
    difeStubs.push(
      this.createDifeSuccessStub('INCLUSIVO@BANCO.COM', 'dife-execution-id-dbmi', 'dife-trace-id-dbmi', {
        type: 'E',
        participant: { nit: '12345678', spbvi: 'CRB' },
    ...
    difeStubs.push(
      this.createDifeSuccessStub('3209876543', 'dife-execution-id-dord', 'dife-trace-id-dord', {
        type: 'M',
        participant: { nit: '12345678', spbvi: 'TFY' }, // Otro participante (Transfiya)
