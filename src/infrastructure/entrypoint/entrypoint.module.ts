...
import { KeyResolutionController } from './rest/key-resolution.controller';

@Module({
  imports: [CoreModule],
  controllers: [TransferController, TransferConfirmationController, HealthController, KeyResolutionController],
  providers: [
    {
      provide: APP_FILTER,
