...
import { MolPaymentQueryRequestDto, MolPaymentQueryResponseDto } from './dto';
...
export declare class MolPaymentProvider implements IMolPaymentProvider {
    ...
    createPayment(request: TransferRequestDto, keyResolution: KeyResolutionResponse): Promise<TransferResponseDto>;
