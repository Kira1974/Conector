...
exports.TransferConfigService = void 0;
const common_1 = require("@nestjs/common");
const generic_config_service_1 = require("./generic-config.service");
let TransferConfigService = class TransferConfigService {
    constructor(config) {
        this.config = config;
    }
    getTransferTimeout() {
        return this.config.get('transfer.timeoutMs');
    }
    getWebhookPollingStartDelay() {
        return this.config.get('transfer.webhookPollingStartDelayMs');
    }
    getPollingInterval() {
        return this.config.get('transfer.pollingIntervalMs');
    }
    isPollingEnabled() {
...
//# sourceMappingURL=transfer-config.service.js.map